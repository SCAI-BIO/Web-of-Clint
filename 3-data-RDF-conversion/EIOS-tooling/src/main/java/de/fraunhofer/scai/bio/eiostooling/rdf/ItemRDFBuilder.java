...
public class ItemRDFBuilder {
    ...
    public Model createDocument(Item item, int i, Map<String, String> prefixes) {
        ...
        if (!item.getTranslatedDescription().isEmpty())
        ...
        if (!item.getAffectedCountriesIso().isEmpty())
        ...
        if (!item.getProcessedOnDate().isEmpty())
