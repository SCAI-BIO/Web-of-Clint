...
public class Satire {
    ...
    public Satire withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Satire withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public Satire withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Satire.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Satire) == false) {
            return false;
        }
        Satire rhs = ((Satire) other);
