...
public class ConspiracyTheory {
    ...
    public ConspiracyTheory withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public ConspiracyTheory withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public ConspiracyTheory withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ConspiracyTheory.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConspiracyTheory) == false) {
            return false;
        }
        ConspiracyTheory rhs = ((ConspiracyTheory) other);
