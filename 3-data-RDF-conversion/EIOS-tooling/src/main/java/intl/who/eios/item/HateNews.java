...
public class HateNews {
    ...
    public HateNews withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public HateNews withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public HateNews withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HateNews.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HateNews) == false) {
            return false;
        }
        HateNews rhs = ((HateNews) other);
