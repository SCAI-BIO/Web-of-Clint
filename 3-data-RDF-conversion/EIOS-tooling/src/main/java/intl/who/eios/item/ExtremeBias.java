...
public class ExtremeBias {
    ...
    public ExtremeBias withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public ExtremeBias withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public ExtremeBias withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ExtremeBias.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExtremeBias) == false) {
            return false;
        }
        ExtremeBias rhs = ((ExtremeBias) other);
