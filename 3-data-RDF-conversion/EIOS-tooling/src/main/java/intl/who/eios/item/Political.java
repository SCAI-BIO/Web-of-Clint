...
public class Political {
    ...
    public Political withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Political withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public Political withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Political.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Political) == false) {
            return false;
        }
        Political rhs = ((Political) other);
