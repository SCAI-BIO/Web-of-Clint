...
public class Disinformation {
    ...
    public Disinformation withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Disinformation withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public Disinformation withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Disinformation.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Disinformation) == false) {
            return false;
        }
        Disinformation rhs = ((Disinformation) other);
