...
public class Credible__1 {
    ...
    public Credible__1 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Credible__1 withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public Credible__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Credible__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Credible__1) == false) {
            return false;
        }
        Credible__1 rhs = ((Credible__1) other);
