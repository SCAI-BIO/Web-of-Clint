...
public class Rumour {
    ...
    public Rumour withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Rumour withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public Rumour withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Rumour.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rumour) == false) {
            return false;
        }
        Rumour rhs = ((Rumour) other);
