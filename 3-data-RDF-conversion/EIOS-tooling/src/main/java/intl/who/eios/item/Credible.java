...
public class Credible {
    ...
    public Credible withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Credible withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public Credible withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Credible.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Credible) == false) {
            return false;
        }
        Credible rhs = ((Credible) other);
