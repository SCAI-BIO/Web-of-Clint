...
public class NotCredible {
    ...
    public NotCredible withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public NotCredible withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public NotCredible withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(NotCredible.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NotCredible) == false) {
            return false;
        }
        NotCredible rhs = ((NotCredible) other);
