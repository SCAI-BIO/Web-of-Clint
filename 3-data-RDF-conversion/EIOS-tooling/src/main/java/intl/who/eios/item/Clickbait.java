...
public class Clickbait {
    ...
    public Clickbait withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Clickbait withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public Clickbait withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Clickbait.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Clickbait) == false) {
            return false;
        }
        Clickbait rhs = ((Clickbait) other);
