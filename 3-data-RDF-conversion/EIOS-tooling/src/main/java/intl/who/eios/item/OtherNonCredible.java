...
public class OtherNonCredible {
    ...
    public OtherNonCredible withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public OtherNonCredible withProbability(Double probability) {
        this.probability = probability;
        return this;
    }
    ...
    public OtherNonCredible withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(OtherNonCredible.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherNonCredible) == false) {
            return false;
        }
        OtherNonCredible rhs = ((OtherNonCredible) other);
