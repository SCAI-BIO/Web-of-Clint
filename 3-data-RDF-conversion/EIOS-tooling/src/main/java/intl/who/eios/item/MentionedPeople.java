...
public class MentionedPeople {
    ...
    public MentionedPeople withNames(List<String> names) {
        this.names = names;
        return this;
    }
    ...
    public MentionedPeople withEntityIds(List<Integer> entityIds) {
        this.entityIds = entityIds;
        return this;
    }
    ...
    public MentionedPeople withOccurrences(List<Occurrence> occurrences) {
        this.occurrences = occurrences;
        return this;
    }
    ...
    public MentionedPeople withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(MentionedPeople.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("names");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MentionedPeople) == false) {
            return false;
        }
        MentionedPeople rhs = ((MentionedPeople) other);
